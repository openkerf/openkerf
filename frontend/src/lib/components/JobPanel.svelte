...
<SeriesRun {series} />
<JobControls {control} {device} {series} job={activeJob} {revision} {nothingBurns} {sheetName} bind:preflight {onJog} {onHome} {onUnlock} {onLock} {onFocus} {onCutPath} {colorFor} {profile} {selectedIds} />
